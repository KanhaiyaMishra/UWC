...
void rp_GenGetAdd(rp_channel_t channel, const volatile int32_t* add)
{
    add = gen_GetDataBuffer(channel);
}

void rp_AcqGetAdd(rp_channel_t channel, const volatile uint32_t* add)
{
    add = osc_GetDataBuffer(channel);
}
